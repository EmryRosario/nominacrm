...
$result = $mysqli->query("SELECT * FROM  `t_estadosemp`");
$options[] = '&nbsp';
//opciones que tendra el dropdown
while ($row = $result->fetch_object()) {
    $options[] = $row->descestado;
}
...
<td>
 ...
 <?php
	  ...
	  //crear array
		...
		include("conectarbbdd.php");
		$optionsprov[] = '&nbsp';
		$resulprov = $mysqli->query("SELECT * FROM  `t_provincias`");
		while ($filaprov = $resulprov->fetch_object()) {
    		$optionsprov[] = $filaprov->nombreprovincia;
		}
